...
export function registerUploadImageTool(server, client) {
    server.registerTool("upload_image", {
        description: "Upload an image to get a hosted URL that can be used as photo_url in templates. Provide either a public URL to re-upload or base64-encoded image data.",
        inputSchema: {
            url: z
                .string()
                .optional()
            ...
            mime_type: z
                .string()
                .optional()
                .describe("MIME type of the image (image/jpeg, image/png, image/webp). Required when using base64."),
        },
